...
<main class="flex-fill">
            <div class="container">
                <h1 style="color: black">Carrinho de Compras</h1>
                <ul class="list-group mb-3">
                    <li class="list-group-item py-3">
                        <div class="row g-3">
                            ...
                            <div class="col-8 col-md-9 col-lg-7 col-xl-8 text-left align-self-center">
                                <h4>
                                    <b><a href="#" class="text-decoration-none " style="color: black">
                                            Abacate</a></b>
                                </h4>
                                <h5>
                    ...
                    <li class="list-group-item py-3">
                        <div class="row g-3">
                            ...
                            <div class="col-8 col-md-9 col-lg-7 col-xl-8 text-left align-self-center">
                                ...
                                <h5>
                                    sandonsaodnasondoasndoasnoidnasiofaiosfnoiasnfioa
                                </h5>
                            </div>
                            <div
                                class="col-6 offset-6 col-sm-6 offset-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-xl-2 align-self-center mt-3">
                    ...
                    <li class="list-group-item py-3">
                        <div class="row g-3">
                            ...
                            <div class="col-8 col-md-9 col-lg-7 col-xl-8 text-left align-self-center">
                                ...
                                <h5>
                                   adslakbklSmfndsnvcklçz,nmcldczxnknnlnknmnkmçnkç
                                </h5>
                            </div>
                            <div
                                class="col-6 offset-6 col-sm-6 offset-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-xl-2 align-self-center mt-3">
                    ...
                    <li class="list-group-item py-3">
                        <div class="text-end">
                            ...
                            <a href="/index.html" class="btn btn btn-primary btn-lg">
                                Continuar Comprando                            
                            </a>
                            <a href="/fechamento_itens.html" class="btn btn-primary btn-lg ms-2 mt-xs-3">Fechar Compra</a>
                        </div>
                    </li>
                </ul>
            </div>
